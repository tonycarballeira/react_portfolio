    ...
    <section id="portfolio">
      <div className="container portfolio__container">
        ...
        <div className="projectCards">
          <div className='cards'>
            <h3 class="project-title"><a href="" rel="noopener noreferrer" target="_blank">Halcyon Theme</a></h3>
            <div class="project-description"><p>A minimal, dark blue theme for VS Code, Sublime Text, Atom, iTerm, and more. Available on </p></div> 
            <ul class="project-tech-list"><li>VS Code</li>
              <li>Sublime Text</li>
              <li>Atom</li>
              <li>iTerm2</li>
              <li>Hyper</li>
